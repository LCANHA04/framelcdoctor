...
HeadroomReport Assess(const FrameSignals& s)
{
    ...
    // Thresholds (tunable; later per-profile).
    const double HI = 90, MID = 70, LOWISH = 80;

    if (gpu >= HI && gpu >= cpuPeak) {
